...
@interface QRCodeController ()<AVCaptureMetadataOutputObjectsDelegate, UIAlertViewDelegate, CAAnimationDelegate>
{
...
- (void)setOverlayPickerView
{
    ...
    centerView.image = [UIImage imageNamed:@"scanning_k"];
    ...
    line.tag = line_tag;
    line.image = [UIImage imageNamed:@"scanning_l"];
    ...
    CGRect leftFrame;
    leftFrame = CGRectMake(-2, 30, 60, 64);
    ...
    [leftButton setImage:[UIImage imageNamed:@"public_imageBack"] forState:UIControlStateNormal];
