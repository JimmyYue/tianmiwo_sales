//
//  InventorySecondViewController.m
...
@interface InventorySecondViewController ()

@end

@implementation InventorySecondViewController
...
- (void)setListNet {
    ...
    [NetworkHandler requestPostWithUrl:storeStockURL parameters:@{@"categoryId":self.categoryId, @"page":self.page, @"limit":@"20"} completion:^(id result) {
