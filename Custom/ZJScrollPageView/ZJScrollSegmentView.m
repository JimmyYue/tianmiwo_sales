...
- (void)setupScrollLineAndCover {
    ...
    if (self.scrollLine) {
        ...
        [_scrollLine.layer insertSublayer:self.gradientLayer atIndex:0];
...
- (CAGradientLayer *)gradientLayer {
    if (_gradientLayer == nil) {
        ...
        gl.frame = self.scrollLine.bounds;
...
- (UIView *)scrollLine {
    ...
    if (!_scrollLine) {
        ...
        lineView.backgroundColor = self.segmentStyle.scrollLineColor;  // line颜色
